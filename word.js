(function(){
    ...
    function playTone(freq, startTime, duration, gainValue = 0.2, type = 'square') {
        if (!audioCtx || !bgmEnabled || muted) return;
    ...
    function toggleMute() {
        ...
        if (!muted && bgmEnabled) audioCtx.resume();
    }
    
    // ---------- GAME MECHANICS (unchanged from previous working version) ----------
